...
using Xunit;
// IZipBackupArchiveFactory moved into this module; alias pins the simple name to the module type
// and avoids ambiguity with the copy still shipped by the referenced Platform.Core NuGet.
...
{
    private static IBackupRestoreManager CreateManager()
    {
