angular.module('platformWebApp')
    .config(['$stateProvider', function ($stateProvider) {
        $stateProvider.state('workspace.exportImport', {
            ...
            controller: ['$scope', 'platformWebApp.bladeNavigationService', function ($scope, bladeNavigationService) {
                var blade = {
                    ...
                    template: 'Modules/$(VirtoCommerce.BackupRestore)/Scripts/blades/exportImport-main.tpl.html',
        ...
        $stateProvider.state('setupWizard.sampleDataInstallation', {
            ...
            templateUrl: 'Modules/$(VirtoCommerce.BackupRestore)/Scripts/templates/sampleDataInstallation.tpl.html',
    ...
    .run(
        [
            ...
            var menuExportImportTemplate =
            {
                ...
                template: 'Modules/$(VirtoCommerce.BackupRestore)/Scripts/notifications/headerNotification.tpl.html',
            ...
            var historyExportImportTemplate =
            {
                ...
                template: 'Modules/$(VirtoCommerce.BackupRestore)/Scripts/notifications/history.tpl.html',
                action: function (notify) {
                    ...
                    var blade = {
                        ...
                        template: isExport ? 'Modules/$(VirtoCommerce.BackupRestore)/Scripts/blades/export-main.tpl.html' : 'Modules/$(VirtoCommerce.BackupRestore)/Scripts/blades/import-main.tpl.html',
                        notification: notify
                    };
                    bladeNavigationService.showBlade(blade);
                }
            ...
            widgetService.registerWidget({
                ...
                template: 'Modules/$(VirtoCommerce.BackupRestore)/Scripts/widgets/sampleDataImportWidget.tpl.html'
            },
                'settingsDetail');
        }]);
